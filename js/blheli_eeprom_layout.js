...
var BLHELI_LAYOUT = {
    ...
    P_GAIN:                     {   offset: 0x03, size: 1,  since: 0 },
    I_GAIN:                     {   offset: 0x04, size: 1,  since: 0 },
    GOVERNOR_MODE:              {   offset: 0x05, size: 1,  since: 0 },
    LOW_VOLTAGE_LIMIT:          {   offset: 0x06, size: 1,  since: 0, until: 0x14 }, // disappeared for MULTI in layout 0x14
    MOTOR_GAIN:                 {   offset: 0x07, size: 1,  since: 0 },
    MOTOR_IDLE:                 {   offset: 0x08, size: 1,  since: 0 },
    STARTUP_POWER:              {   offset: 0x09, size: 1,  since: 0 },
    PWM_FREQUENCY:              {   offset: 0x0A, size: 1,  since: 0 },
    MOTOR_DIRECTION:            {   offset: 0x0B, size: 1,  since: 0 },
    INPUT_PWM_POLARITY:         {   offset: 0x0C, size: 1,  since: 0 },
    MODE:                       {   offset: 0x0D, size: 2,  since: 0 },
    PROGRAMMING_BY_TX:          {   offset: 0x0F, size: 1,  since: 0 },
    REARM_AT_START:             {   offset: 0x10, size: 1,  since: 0 },
    GOVERNOR_SETUP_TARGET:      {   offset: 0x11, size: 1,  since: 0 },
    STARTUP_RPM:                {   offset: 0x12, size: 1,  since: 0 },
    STARTUP_ACCELERATION:       {   offset: 0x13, size: 1,  since: 0 },
    VOLT_COMP:                  {   offset: 0x14, size: 1,  since: 0 },
    COMMUTATION_TIMING:         {   offset: 0x15, size: 1,  since: 0 },
    DAMPING_FORCE:              {   offset: 0x16, size: 1,  since: 0 },
    GOVERNOR_RANGE:             {   offset: 0x17, size: 1,  since: 0 },
    STARTUP_METHOD:             {   offset: 0x18, size: 1,  since: 0 },
    ...
    THROTTLE_RATE:              {   offset: 0x1E, size: 1,  since: 0 },
    DEMAG_COMPENSATION:         {   offset: 0x1F, size: 1,  since: 0 },
    BEC_VOLTAGE:                {   offset: 0x20, size: 1,  since: 0 },
    PPM_CENTER_THROTTLE:        {   offset: 0x21, size: 1,  since: 0 },
    SPOOLUP_TIME:               {   offset: 0x22, size: 1,  since: 0 },
    TEMPERATURE_PROTECTION:     {   offset: 0x23, size: 1,  since: 0 },
    LOW_RPM_POWER_PROTECTION:   {   offset: 0x24, size: 1,  since: 0x14 },
    PWM_INPUT:                  {   offset: 0x25, size: 1,  since: 0x14 },
    PWM_DITHER:                 {   offset: 0x26, size: 1,  since: 0x14 },
